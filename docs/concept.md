...
2. взависимости от установленного значения [rate_limit](#rate_limit-ratelimitmode)
...
Можно выключить в конфиге (см. [load_on_getitem](config.md#load_on_getitem-bool))
```python
posts = Posts()
